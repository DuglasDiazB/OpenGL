...
{	
    ...
    GLfloat light_position[] = { 0.5, 0.5, -0.5, 12.0 };  //2
...
//dibujamos un cubo para la superficie de mesa
void superficie_mesa()
{
    ...
    //establecemos los parametros de la funcion material
...
void tetera()
{
   ...
   material(0.24725,0.1995,0.0745,0.75164,0.60648,0.22648,0.628281,0.555802,0.366065,0.4);

   glTranslatef(0.0f, -0.10f, -0.2f);
   //glColor3f(1.0,  1.0,  0.0 );
   glutSolidTeapot(0.05);
}


//dibujamos un cubo que representa las pata de la mesa
void pata()
{
    // Rotar en el eje X,Y y Z
    glRotatef( rotate_x, 1.0, 0.0, 0.0 );
