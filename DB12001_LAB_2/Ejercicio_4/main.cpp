...
void inferior(){
   glLoadIdentity();
     Material(0.24725, 0.1995, 0.0745, 0.75164, 0.60648, 0.22648, 0.628281, 0.555802, 0.366065, .078125);
     glRotatef( rotate_x, 1.0, 0.0, 0.0 );
    glRotatef( rotate_y, 0.0, 1.0, 0.0 );
    glRotatef( rotate_z, 0.0, 0.0, 1.0 );
    GLfloat light_position[] = { 2.0, -2.0, 2.0, 12.0 };  
    glLightfv(GL_LIGHT0, GL_POSITION, light_position);
...
void display()
{
    ...
    glRotatef( 7, 1.0, 0.0, 0.0 );
    glRotatef( -7, 0.0, 1.0, 0.0 );
    Material(0.0, 0.0, 0.0, 0.5, 0.0, 0.0, 0.7, 0.6, 0.6, .078125);
    //Esfera_Izquierda
